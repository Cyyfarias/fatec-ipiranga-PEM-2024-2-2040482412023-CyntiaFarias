 ...
 snprintf(&tabuleiro[i], 4, "PP%d", (i - 32) / 4 + 1); // Peças de a2 a h2
 }
 ...
 snprintf(&tabuleiro[i], 4, "BP%d", (i - 192) / 4 + 1); // Peças de a7 a h7
 }
 printf("*******************************\n");
 printf(" Início \n");
 printf("*******************************\n");
 ...
 printf("\n");
 printf("*******************************\n");
 printf(" 1ª Jogada Brancas \n");
 printf("*******************************\n");
 printf("\ BRANCAS DE PE2 PARA PE4 \n");
 printf("-------------------------------\n");
 printf("\n");
