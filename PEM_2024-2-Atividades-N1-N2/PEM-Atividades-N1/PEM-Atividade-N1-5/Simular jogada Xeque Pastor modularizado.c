/*--------------------------------------------------------*
 * Disciplina: ProgramaÃ§ao Estruturada e Modular *
 * Prof. Carlos VerÃ-ssimo
 *--------------------------------------------------------*
 ...
 *--------------------------------------------------------*/
 ...
 snprintf(&tabuleiro[i], 4, "PP%d", (i - 32) / 4 + 1); // PeÃμes de a2 a h2
 }
 ...
 snprintf(&tabuleiro[i], 4, "BP%d", (i - 192) / 4 + 1); // PeÃμes de a7 a h7
 }
 }
